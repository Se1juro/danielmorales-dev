        ...
        <div className="lg:text-center">
          ...
          <div className="projects-container flex flex-wrap">
            {projects && projects.map((project,index)=>(
              <div className="card-project max-w-sm w-1/3 bg-white rounded-lg border mr-10 border-gray-200 shadow-md  mb-5 p-3" key={index}>
                ...
                {project.githubLink && <a href={project.githubLink} className="link-repository inline-flex items-center py-2 px-3 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 ">
                  Visitar repositorio
