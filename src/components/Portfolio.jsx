        ...
        <div className="lg:text-center">
          ...
          <div className="projects-container flex flex-wrap">
            {projects && projects.map((project,index)=>(
              <div className="max-w-sm w-1/3 bg-white rounded-lg border mr-10 border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700 mb-5 p-3" key={index}>
                ...
                <div className="p-5" style={{maxHeight:"10em",height:"10em"}}>
                ...
                {project.githubLink && <a href={project.githubLink} className="inline-flex items-center py-2 px-3 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                  Visitar repositorio
